...
public class PlayerScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            DesiredVel = SprintSpeed;
        }
        else
        {
            DesiredVel = DefaultSpeed;
        }
        ...
        if (Speed != DesiredVel)
        {
            Speed = Mathf.Lerp(Speed, DesiredVel, 0.1f);
            //SprintSpeed = DesiredVel;
        }
        ...
        //vel.x = Mathf.Lerp(vel.x, DesiredVel, 0.3f * Time.deltaTime);
